...
# Encode directions as numbers for easier programming.
class Action(Enum):
    UP = 0
    DOWN = 1
    LEFT = 2
...
class MazeEnv(gym.Env):
    ...
    # The close function can be called to close any processes that may be opened during the environment,
    # such as virtual monitors. It is not required for the purpose of this task.
    def close(self):
        pass
    
    # This callable property attribute defines the possible actions from the action space.
    @property
    def actions(self):
